...
Router.map(function() { 
	...
	this.route('legendManagement', {
		path: '/legends/:_id/manage',
        ...
        waitOn: function() {
        	return [Meteor.subscribe('chapters', this.params._id), Meteor.subscribe('legend', this.params._id)];
        },
        data: function() { 
	...
	this.route('legendView', { 
		path: '/legends/:_id',
		layoutTemplate: 'legendViewLayout',
		waitOn: function() {
			return [Meteor.subscribe('legend', this.params._id), Meteor.subscribe('chapters', this.params._id), Meteor.subscribe('themes')];
		},
		action: function () {
